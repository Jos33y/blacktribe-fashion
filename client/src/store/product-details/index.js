                ...
                (<PageLoading />) : (
                    <>
                        ...
                        <div className="product-details-container">
                            ...
                            <DetailsBreadCrumb breadImg={product.imgUrls[0] ? product.imgUrls[0] : '' } cat_name={category ? category.categoryName : ''} prod_name={product ? product.productName : ''} />
                                        ...
                                        <div className="details-sect-info">
                                            ...
                                            <div className="prod-cart">
                                                <div className="prod-size">
                                                    <select className="form-control" name="prod_size" id="prod_size"> 
                                                ...
                                                <div className="add-cart">
                                                    <button disabled={disabled} onClick={() => addToCart(product)} className="btn btn-md btn-primary">
                                                        {disabled ? 'Adding to cart...' :  'Add to Cart'} <i className="fa-solid fa-cart-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
