                    ...
                    <div className="cart-product-details">
                        ...
                        <div className="prod-quantity">
                            <div className="form-group">
                                <button onClick={handleDecrement} className="btn btn-sm btn-primary"> <i className="fa-solid fa-minus"></i> </button>
                                <input className="form-control" type="text" value={quantity} maxLength="3" readOnly />
                                <button onClick={handleIncrement} className="btn btn-sm btn-secondary"> <i className="fa-solid fa-plus"></i> </button>
                            </div>
                        </div>
                    </div>
