                ...
                <div className="navbar-header">
                    <div className="navbar-logo">
                        ...
                        <div className="logo-name">
                            <p className="logo-text">BlackTribe Fashion </p>
                        </div>
                    </div>
                    ...
                    <div className="navbar-others">
                        <ul>
                            <li>
                                <button className="btn btn-secondary" onClick={darkMode} title="Light Mode"> <i className="fa-solid fa-sun"></i> </button>
                            </li>
                            ...
                            <li> <div className="nav-profile"> <img src={BlackTemp} alt="nav-profile" className="img-fluid" /> </div> </li>
                        </ul>
                    </div>
                </div>
            </div>
